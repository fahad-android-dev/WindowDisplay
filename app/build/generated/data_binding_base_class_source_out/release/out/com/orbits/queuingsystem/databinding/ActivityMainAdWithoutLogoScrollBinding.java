...
public final class ActivityMainAdWithoutLogoScrollBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainAdWithoutLogoScrollBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityMainAdWithoutLogoScrollBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainAdWithoutLogoScrollBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_ad_without_logo_scroll, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainAdWithoutLogoScrollBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainAdWithoutLogoScrollBinding((LinearLayout) rootView,
          llContainerLogoAdToken, llContainerLogoAds, llFragmentTokenContainer,
          llMainActivityTopParent);
    }
