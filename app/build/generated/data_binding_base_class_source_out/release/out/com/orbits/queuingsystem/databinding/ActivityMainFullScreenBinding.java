...
public final class ActivityMainFullScreenBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainFullScreenBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivityMainFullScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainFullScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_full_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainFullScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainFullScreenBinding((LinearLayout) rootView, llContainerLogoAdToken,
          llFragmentTokenContainer, llMainActivityTopParent);
    }
