...
public final class DialogDbconfigBinding implements ViewBinding {
  ...
  private DialogDbconfigBinding(@NonNull LinearLayout rootView, @NonNull CheckBox checkboxAll,
      ...
      @NonNull Spinner spinnerCounterSelection, @NonNull Spinner spinnerMiddle,
      @NonNull Spinner spinnerTop, @NonNull TextView textBranchName, @NonNull TextView textCheck,
      @NonNull TextView textCounterNo, @NonNull TextView textQueueTcpPort,
      @NonNull TextView textServerName, @NonNull TextView textServiceName,
      @NonNull TextView txtCurrentTime) {
  ...
  public static DialogDbconfigBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spinnerCounterSelection;
      Spinner spinnerCounterSelection = ViewBindings.findChildViewById(rootView, id);
      if (spinnerCounterSelection == null) {
        break missingId;
      }
      ...
      return new DialogDbconfigBinding((LinearLayout) rootView, checkboxAll, chkAndroid,
          ...
          editTimeToRestart, spinnerAdCounter, spinnerCounterSelection, spinnerMiddle, spinnerTop,
          textBranchName, textCheck, textCounterNo, textQueueTcpPort, textServerName,
          textServiceName, txtCurrentTime);
    }
